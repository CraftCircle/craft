...
export class NotificationService {
  ...
  async sendEmailNotification(
    ...
    try {
      ...
      <body>
        <div class="container">
          <img src="https://res.cloudinary.com/djhugxcv9/image/upload/v1743468786/logo_ph9j6b.png" alt="CraftCircle Logo" style="max-width: 150px;" />
          <div class="content">
            <p>${body.message}</p>
            <a href="https://craftcirclehq.com/" class="button">Get Started</a>
          </div>
          <div class="footer">
            <p>If you have any questions, feel free to contact us at mailto:support@craftcirclehq.com</p>
